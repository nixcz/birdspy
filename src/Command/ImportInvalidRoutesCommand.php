...
class ImportInvalidRoutesCommand extends Command
{

    protected static $defaultName = 'app:import-invalid-routes';
    ...
    /**
     * ImportInvalidRoutesCommand constructor.
     *
    ...
    {
        $this
            ->setDescription('Import invalid routes from all servers.')
            ->setHelp('This command allows you to import invalid routes from all Route Servers.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $output->writeln(
                sprintf(
                    "\n<info>End of importing all invalid routes, script was running %.2f s.\nUsed maximum memory %.2f MiB.\n</info>",
