...
class ImportServerFilteredRoutesCommand extends Command
{

    protected static $defaultName = 'app:import-server-filtered-routes';
    ...
    /**
     * ImportServerFilteredRoutesCommand constructor.
     *
    ...
    {
        $this
            ->setDescription('Import filtered routes from server.')
            ->setHelp('This command allows you to import filtered routes from Route Server.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $output->writeln(
                sprintf(
                    "<info>End of importing filtered routes from server %s, script was running %.2f s.\nUsed maximum memory %.2f MiB.\n</info>",
                    $server->getName(),
